...
import type { DrawdownPoint } from "@/lib/pension";
...
export default function RetirementDrawdownChart({ data, retirementAge, selectedScenario }: Props) {
  ...
  return (
    <div className="flex flex-col gap-1">
      <h2 className="text-lg font-semibold text-gray-100">Desacumulación del fondo</h2>
      <p className="text-sm text-gray-400">
        Capital disponible durante el retiro a partir de los {retirementAge} años · el fondo sigue
        generando rendimientos mientras retiras
      </p>
      <div className="mt-3">
        <ResponsiveContainer width="100%" height={280}>
          <AreaChart data={data} margin={{ top: 4, right: 8, left: 8, bottom: 0 }}>
            <defs>
              <linearGradient id="dd-grad-pessimistic" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#f97316" stopOpacity={0.15} />
                <stop offset="95%" stopColor="#f97316" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="dd-grad-base" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#3b82f6" stopOpacity={0.2} />
                <stop offset="95%" stopColor="#3b82f6" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="dd-grad-optimistic" x1="0" y1="0" x2="0" y2="1">
