  ...
  return (
    <div>
      <p className="text-sm text-gray-400 mb-3">
        Crecimiento año a año del salario mínimo. La línea punteada es el promedio histórico (
        {avgLine.toFixed(1)}% anual). La varianza justifica el uso de escenarios en lugar de una
        sola proyección.
      </p>
