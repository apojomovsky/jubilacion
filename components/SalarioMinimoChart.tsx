      ...
      return {
        ...
        slow: isProjection
          ? projectSalarioMinimo({
              currentValue: slow.baseValue,
              currentYear: baseYear,
              targetYear: year,
              annualGrowthRate: slow.annualGrowthRate,
            })
          : null,
        moderate: isProjection
          ? projectSalarioMinimo({
              currentValue: moderate.baseValue,
              currentYear: baseYear,
              targetYear: year,
              annualGrowthRate: moderate.annualGrowthRate,
            })
          : null,
        fast: isProjection
          ? projectSalarioMinimo({
              currentValue: fast.baseValue,
              currentYear: baseYear,
              targetYear: year,
              annualGrowthRate: fast.annualGrowthRate,
            })
          : null,
      };
    });
  ...
  return (
    <div>
      <p className="text-sm text-gray-400 mb-3">
        Datos históricos (puntos) y proyección hasta {targetYear} (líneas). Año base de proyección:{" "}
        {baseYear}.
      </p>
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={chartData} margin={{ top: 4, right: 8, left: 8, bottom: 0 }}>
          ...
          <ReferenceLine
            ...
            stroke="#6b7280"
            strokeDasharray="4 2"
            label={{ value: "hoy", position: "insideTopRight", fontSize: 11, fill: "#6b7280" }}
          />
          <Line
            type="monotone"
            dataKey="historical"
